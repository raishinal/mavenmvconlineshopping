...
<!--                                        <a href="#">Politics,</a>
                                    ...
                                    <ul class="blog_meta list">
                                        <li><a href="#">${bl.title}<i class="lnr lnr-user"></i></a></li>
                                        <li>${bl.now}<i class="lnr lnr-calendar-full"></i></li>
                                        <li><a href="#">1.2K Views<i class="lnr lnr-eye"></i></li>
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <a href="<c:url value="/Blog/${bl.id}"/>">
                                        <img src="<c:url value="/resources/blogimage/${bl.imageName}"/>" alt=""/></a>
                                    <div class="blog_details">
                                        <a href="<c:url value="/Blog/${bl.id}"/>">
                                            <h2>${bl.title}</h2>
                                        </a>
                                        <p>${blog.description}</p>
                                        <a href="<c:url value="/Blog/${bl.id}"/>" class="white_bg_btn">View More</a>
                                    </div>
                                </div>
                            </div>
                        </article>
