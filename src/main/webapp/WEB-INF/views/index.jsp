				...
				<div class="col-lg-12">
					<div class="active-banner-slider owl-carousel">
						<!-- single-slide -->
                                                ...
                                                <c:forEach items="${sliderlist}" var="si">
                                                     
						<div class="row single-slide align-items-center d-flex">
							<div class="col-lg-5 col-md-6">
								<div class="banner-content">
                                                                    <h3><a href="<c:url value="/News/Show/${si.id}"/>">${si.title} </a><br></h3>
									<div class="add-bag d-flex align-items-center">
										<span class="add-text text-uppercase">Added in: ${si.now}</span>
									</div>
								</div>
							</div>
							<div class="col-lg-7">
								<div class="banner-img">
                                                                    <img class="img-fluid" src="<c:url value="/resources/newsimage/${si.imageName}"/>" alt="">
								</div>
							</div>
						</div>
                                                                	<!-- single-slide -->
			...
			<div class="row features-inner">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-features">
						<div class="f-icon">
                                                    <img src="<c:url value="/resources/front/img/features/f-icon1.png"/>" alt="">
						</div>
						<h6>Free Delivery</h6>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-features">
						<div class="f-icon">
                                                    <img src="<c:url value="/resources/front/img/features/f-icon2.png"/>" alt="">
						</div>
						<h6>Return Policy</h6>
						<p>Free Shipping on all order</p>
					</div>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-features">
						<div class="f-icon">
                                                    <img src="<c:url value="/resources/front/img/features/f-icon3.png"/>" alt="">
						</div>
						<h6>24/7 Support</h6>
						<p>Free Shipping on all order</p>
					</div>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-features">
						<div class="f-icon">
                                                    <img src="<c:url value="/resources/front/img/features/f-icon4.png"/>" alt="">
						</div>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						...
						<div class="single-product">
                                                    <a href="<c:url value="/Product/${pro.id}"/>">
                                                    <img class="img-fluid" src="<c:url value="/resources/productimage/${pro.imageName}"/>" alt=""></a>
							<div class="product-details">
                                                            <h6><a href="<c:url value="/Product/${pro.id}"/>">${pro.name}</a></h6>
								<div class="price">
									<h6>Rs : ${pro.price}</h6>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						...
						<div class="single-product">
                                                    <a href="<c:url value="/Blog/${bl.id}"/>">
                                                    <img class="img-fluid" src="<c:url value="/resources/blogimage/${bl.imageName}"/>" alt=""></a>
							<div class="product-details">
                                                            <h6><a href="<c:url value="/Blog/${bl.id}"/>">${bl.title}</a></h6>
								<div class="price">
									<h6>${pro.now}</h6>
<!--									<h6 class="l-through">$210.00</h6>-->
								</div>
