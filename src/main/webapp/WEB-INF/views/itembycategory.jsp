		...
		<div class="row">
			<div class="col-xl-3 col-lg-4 col-md-5">
				<div class="sidebar-categories">
					...
					<ul class="main-categories">
                                            ...
                                            <li class="main-nav-list"><a data-toggle="collapse" href="#${cat.title}" aria-expanded="false" aria-controls="${cat.title}"><span
								 class="lnr lnr-arrow-right"></span>${cat.title}<span class="number">(53)</span></a>
							<ul class="collapse" id="${cat.title}" data-toggle="collapse" aria-expanded="false" aria-controls="${cat.title}">
                                                            <c:forEach items="${tagslist}" var="tag">
                                                                <c:if test="${tag.title==cat.title}">
                                                               
                                                            <li class="main-nav-list child"><a href="<c:url value="/Product/Category/Show/${tag.tags}"/>">${tag.tags}<span class="number">(13)</span></a></li>
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<section class="lattest-product-area pb-40 category-list">
					<div class="row">
						<!-- single product -->
                                                <c:forEach items="${tagitem}" var="pro">
						<div class="col-lg-4 col-md-6">
							<div class="single-product"><a href="<c:url value="/Product/${pro.id}"/>">
