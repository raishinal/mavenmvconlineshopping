        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 posts-list">
                    <c:forEach items="${blogitem}" var="bl">
                    <div class="single-post row">
                        <div class="col-lg-12">
                            <div class="feature-img">
                                <img class="img-fluid" src="<c:url value="/resources/blogimage/${bl.imageName}"/>" alt="">
                            </div>
                        </div>
...
<!--                                    <a class="active" href="#">Technology,</a>
                                ...
                                <ul class="blog_meta list">
                                    <li><a href="#">Blogger<i class="lnr lnr-user"></i></a></li>
                                    <li>${bl.now}<i class="lnr lnr-calendar-full"></i></li>
                                    <li>1.2M Views<i class="lnr lnr-eye"></i></li>
                                    <li>06 Comments<i class="lnr lnr-bubble"></i></li>
                                </ul>
                            </div>
                        </div>
